...
/** Dark pill on light background - brun foncé charte TD8b. */
export const btnDark = `${base} bg-brun-fonce text-sand px-[30px] py-4`;
/** Smaller dark pill (nav). */
export const btnDarkSm = `${base} bg-brun-fonce text-sand px-[26px] py-3.5`;
...
export const btnDarkLg = `${base} bg-brun-fonce text-sand px-[42px] py-[18px] text-[15px]`;
